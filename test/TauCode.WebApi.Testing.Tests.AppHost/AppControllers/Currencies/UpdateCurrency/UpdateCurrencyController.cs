...
using TauCode.WebApi.Testing.Tests.AppHost.Core.Features.Currencies.UpdateCurrency;
...
namespace TauCode.WebApi.Testing.Tests.AppHost.AppControllers.Currencies.UpdateCurrency
{
    [ApiController]
