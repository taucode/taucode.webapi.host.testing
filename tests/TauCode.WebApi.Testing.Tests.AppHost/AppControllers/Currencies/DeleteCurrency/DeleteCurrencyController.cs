...
using TauCode.WebApi.Testing.Tests.AppHost.Core.Features.Currencies.DeleteCurrency;
...
namespace TauCode.WebApi.Testing.Tests.AppHost.AppControllers.Currencies.DeleteCurrency
{
    [ApiController]
